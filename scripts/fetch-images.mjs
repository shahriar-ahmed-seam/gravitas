/**
 * Build-time image pipeline for Gravitas.
 *
...
const ASSETS = [
  { name: 'hero', query: 'galaxy nebula deep space stars', w: 3840, orientation: 'landscape' },
  { name: 'feature-gravity', query: 'spiral galaxy space dark', w: 1600, orientation: 'landscape' },
  { name: 'feature-blackhole', query: 'black hole accretion space render', w: 1600, orientation: 'landscape' },
  { name: 'feature-orbits', query: 'planets solar system space', w: 1600, orientation: 'landscape' },
  { name: 'showcase', query: 'milky way galaxy night sky', w: 2560, orientation: 'landscape' },
];
...
async function main() {
  ...
  for (const asset of ASSETS) {
    ...
    credits.push({
      ...
      authorUrl: `${photo.user.links.html}?utm_source=gravitas&utm_medium=referral`,
      source: `${photo.links.html}?utm_source=gravitas&utm_medium=referral`,
    });
